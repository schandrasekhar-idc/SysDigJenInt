...
public class SysDig_TC_Assessment 
{
		...
		public static void assessment() throws InterruptedException//main(String[] args) throws InterruptedException
		{
			...
			// SysDig.manage().timeouts().implicitlyWait(30,TimeUnit.SECONDS);
			SysDig.manage().window().maximize();
			SysDig.get("https://dev-sysdigroi.webappuat.com/");
			SysDig.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			...
			Thread.sleep(2000);
			SysDig.findElement(By.xpath("//div[@id='warning']/div/div/div[3]/a")).click();

			// AGREE AND CONTINUE - Cookie
			Thread.sleep(2000);
			SysDig.findElement(By.xpath("//div[@class='cookie-section']/div/div/div[2]/p/a[2]")).click();

			// Verify if Begin Assessment button is present
			if (SysDig.findElements(By.xpath("/html/body/div/div[2]/div/div/div/a")).size() != 0) {
			...
			int BeginAssessmentBtnSize = SysDig.findElements(By.xpath("/html/body/div/div[2]/div/div/div/a")).size();
			System.out.println("Number of begin button(s) present :  " + BeginAssessmentBtnSize);

			// Click - Begin Assessment
			SysDig.findElement(By.xpath("//div[@id=\"landing\"]/div/div/div/a")).click();
			// SysDig.findElement(By.xpath("/html/body/div/div[2]/div/div/div/a")).click();
			...
			SysDig.findElement(By.xpath("//*[@id=\"Q1-QI1-AC1\"]")).sendKeys("5000");

			// Tab out to prefill other fields on the Assessment Page-1
			SysDig.findElement(By.xpath("//*[@id=\"Q1-QI1-AC1\"]")).sendKeys(Keys.TAB);

			// Verify if Next button is present
			if (SysDig.findElements(By.xpath("//form[@id='sectionForm1']/div/section/div/div/button[@id='btnNext']"))
					.size() != 0) {
				System.out.println("Element is Present");
			} else {
				System.out.println("Element is Absent");
			...
			// click Next button
			SysDig.findElement(By.xpath("//form[@id='sectionForm1']/div/section/div/div/button[@id='btnNext']")).click();
			...
			if (SysDig.findElements(By.xpath("//form[@id='sectionForm2']/div/section/div/div/button[@id='btnNext']"))
					.size() != 0) {
				System.out.println("Element is Present");
			}
			...
			Thread.sleep(10000);
			// click Next button
			SysDig.findElement(By.xpath("//form[@id='sectionForm2']/div/section/div/div/button[@id='btnNext']")).click();
			...
			if (SysDig.findElements(By.xpath("//form[@id='sectionForm3']/div/section/div/div/button[@id='btnNext']"))
					.size() != 0) {
				System.out.println("Element is Present");
			}
			...
			Thread.sleep(10000);
			// click Next button
			SysDig.findElement(By.xpath("//form[@id='sectionForm3']/div/section/div/div/button[@id='btnNext']")).click();
			...
			if (SysDig.findElements(By.xpath(
			...
			Thread.sleep(10000);
			// Select Industry
			  WebElement Industry = SysDig.findElement(By.cssSelector(
			...
			Thread.sleep(10000);
			  ...
			  WebElement Country = SysDig.findElement(By.cssSelector(
			  ...
			  SysDig.findElement(By.xpath("//form[@id='sectionForm4']/div/section/div/div/button[@id='btnNext']")).click();
				System.out.println("On Assessment Page-4, Next button is clicked");

			// ****************************************Registration Page***************************************************//
				//Find and Enter a value in First Name web element
				
				SysDig.findElement(By.xpath("//*[@id='Q6-QI16-AC293']")).sendKeys("Test First name");
				
				SysDig.findElement(By.xpath("//*[@id='Q7-QI17-AC294']")).sendKeys("Test Last name");
				
				
				SysDig.findElement(By.xpath("//*[@id='Q8-QI18-AC295']")).sendKeys("IDC Test Assessment");
				
				
				SysDig.findElement(By.xpath("//*[@id='Q9-QI19-AC296']")).sendKeys("idc.test.adm@webappuat.com");
				
				
				SysDig.findElement(By.xpath("//*[@id='Q10-QI20-AC297']")).sendKeys("Test Job title");
				
				SysDig.findElement(By.xpath("//*[@id='callThankyou']")).click();
