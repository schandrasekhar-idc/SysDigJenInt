...
public class SysDig_ElementLocators 
{
	...
	//*[@id="myModalLabel"]
	public SysDig_ElementLocators(WebDriver SysDig)
	{
		this.SysDig = SysDig;		
	}
	...
	{
		wait = new WebDriverWait(SysDig, 30);
		wait.until(ExpectedConditions.titleIs("Sysdig Business Value Snapshot"));
		
		System.out.println(" Page Title is: Sysdig Business Value Snapshot" );
	}
